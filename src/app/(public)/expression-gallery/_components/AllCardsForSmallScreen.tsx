...
import PurchaseAACCoreBoard from "./PurchaseAACCoreBoard";import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
;

const AllCardsForSmallScreen = () => {
  return (
    <Container>
...
export default AllCardsForSmallScreen;
