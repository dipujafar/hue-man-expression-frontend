...
const BuyNowSection = () => {
  ...
  return (
    <>
      <div id="combo" className="relative ">
        <Image
          src={SectionBg}
          alt="sectionBgImage"
        ...
        <div className="absolute inset-0 ">
          <div className="flex flex-col justify-center items-center w-full h-full px-4 py-4 text-primary-white lg:gap-y-8 md:gap-y-2">
            <div id="combo" className="flex flex-col justify-center items-center lg:gap-y-4 md:gap-y-2 gap-y-1">
              <p className="text-center text-primary-white xl:text-2xl  md:text-sm text-[12px]  xl:max-w-6xl md:max-w-3xl max-w-xl px-10">
